...
import { SET_SIDEBAR_TYPE, SET_NOTES, SET_SIDEBAR_CONTENT, SET_SIDEBAR_TITLE, LOAD_DATA, LOAD_NEW_PAGE, SET_TOTAL_NOTES, SET_ORDER_BY } from "./modules/sidebar/types";
import { setSidebarType, setNotes, setSidebarContent, setSidebarTitle, loadData, loadNewPage, setTotalNotes, setOrderBy} from "./modules/sidebar/actions";
